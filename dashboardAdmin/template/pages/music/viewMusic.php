								...
								<div class="card-body">
									...
									<form class="forms-sample" method="POST" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<input type="text" name="artist" class="form-control" id="exampleInputEmail3" autocomplete="off" placeholder="Artist" required>
										</div>
										<div class="form-group">
											<label for="exampleInputPassword4">Genre</label>
											<input type="text" name="genre" class="form-control" id="exampleInputPassword4" autocomplete="off" placeholder="Genre" required>
										</div>
										<div class="form-group">
